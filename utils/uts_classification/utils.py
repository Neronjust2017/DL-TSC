...
def readmts_ptb_aug(filename):
    ...
    X_train, Y_train = slide_and_cut(X_train, Y_train, window_size=5000, stride=500, s1=s1,s2=s2,s3=s3,s4=s4,output_pid=False)
    ...
    X_val, Y_val = slide_and_cut(X_val, Y_val, window_size=5000, stride=500, s1=s1,s2=s2,s3=s3,s4=s4,output_pid=False)
    ...
    X_test, Y_test = slide_and_cut(X_test, Y_test, window_size=5000, stride=500, s1=s1,s2=s2,s3=s3,s4=s4,output_pid=False)
