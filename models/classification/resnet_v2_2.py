...
class Classifier_RESNET_V2:
    def __init__(self,input_shape, nb_classes,type=1, convfilt=64, ksize=16, depth=25,drop=0.5):

        if type==1:
            self.model = self.build_model(input_shape, nb_classes, convfilt, ksize, depth,drop)
        elif type==2:
            self.model = self.build_model_without_dropout(input_shape,nb_classes,convfilt, ksize, depth,drop)
        elif type==3:
            self.model = self.build_model_with_L2(input_shape,nb_classes,convfilt, ksize,depth,drop)
        elif type==4:
            self.model = self.get_resnet34_se(input_shape,nb_classes,convfilt, ksize,depth,drop)
        elif type==5:
            self.model = self.get_resnet34_BNGammaZero(input_shape,nb_classes,convfilt, ksize,depth,drop)
        elif type==6:
            self.model = self.get_resnet34_BN2(input_shape,nb_classes,convfilt, ksize,depth,drop)

    def build_model(self,input_shape,nb_classes,convfilt, ksize, depth,drop):
    ...
    def build_model_without_dropout(self,input_shape,nb_classes,convfilt, ksize,depth,drop):
    ...
    def build_model_with_L2(self,input_shape,nb_classes,convfilt, ksize,depth,drop):
    ...
    def get_resnet34_se(self,input_shape,nb_classes,convfilt, ksize,depth,drop):
    ...
    def get_resnet34_BNGammaZero(self,input_shape,nb_classes,convfilt, ksize,depth,drop):
    ...
    def get_resnet34_BN2(self,input_shape,nb_classes,convfilt, ksize,depth,drop):
...
if __name__ == '__main__':
    ...
    model = Classifier_RESNET_V2((30000,1), 3, type=1).model
    model.summary()
