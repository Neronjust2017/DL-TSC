...
clf = ak.AutoModel(inputs=input_node, outputs=output_node, max_trials=30,  tuner='random',
                   name='UCI_resnet_v2_Random',directory='nas_result')

sys.stdout = Logger('nas_result/UCI_resnet_v2_Random/log', sys.stdout)
sys.stderr = Logger('nas_result/UCI_resnet_v2_Random/log_file', sys.stderr)		# redirect std err, if necessary
...
model.save('nas_result/UCI_resnet_v2_Random/bestmodel.h5')