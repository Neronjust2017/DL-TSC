...
clf = ak.AutoModel(inputs=input_node, outputs=output_node, max_trials=30, tuner='bayesian',
                   name='UCI_inceptiontime_BO',directory='nas_result')

sys.stdout = Logger('nas_result/UCI_inceptiontime_BO/log', sys.stdout)
sys.stderr = Logger('nas_result/UCI_inceptiontime_BO/log_file', sys.stderr)		# redirect std err, if necessary
...
model.save('nas_result/UCI_inceptiontime_BO/bestmodel.h5')
