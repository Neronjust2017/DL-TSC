...
clf = ak.AutoModel(inputs=input_node, outputs=output_node, max_trials=20,
                   name='2018_resnet_v2_Greedy',directory='nas_result')
#
sys.stdout = Logger('nas_result/2018_resnet_v2_Greedy/log', sys.stdout)
sys.stderr = Logger('nas_result/2018_resnet_v2_Greedy/log_file', sys.stderr)		# redirect std err, if necessary
...
# model.save('nas_result/2018_resnet_v2_Greedy/bestmodel.h5')