...
def process_config_UtsClassification_bayes_optimization(json_file, learning_rate, model_name, batch_size, num_epochs=100 ):
...
def main():
    ...
    try:
        ...
        config = process_config_UtsClassification_bayes_optimization(args.config,PARAMS['learning_rate'],PARAMS['model_name'],PARAMS['batch_size'])
        # except:
